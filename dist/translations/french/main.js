...
const translations = {
  ...
  strings: {
    ...
    "* <strong>Global Bot</strong> - An automated account that can use HTML anywhere": "* <strong>Global Bot</strong> - Un compte automatis\xE9 qui peut utiliser le HTML n'importe o\xF9",
    ...
    "* <strong>Bot</strong> - An automated account that can mute, warn, and use HTML": "* <strong>Bot</strong> - Un compte automatis\xE9 qui peut mute, warn et utiliser le HTML",
    ...
    "<strong>lock</strong> - Locks a user (makes them unable to talk in any rooms or PM non-staff) for 2 days.": "<strong>lock</strong> - Lock un utilisateur (l'emp&ecirc;che de parler sur n'importe quelle room ou d'envoyer des messages priv&eacute;s \xE0 des utilisateurs hors staff) pendant 2 jours.",
    ...
    "<strong>globalban</strong> - Globally bans (makes them unable to connect and play games) for a week.": "<strong>globalban</strong> - Bannit compl\xE8tement (emp&ecirc;che de se connecter et de jouer) pendant une semaine.",
    ...
    "- /roomintro <em>intro</em>: set the room introduction that will be displayed for all users joining the room": "- /roomintro <em>introduction</em> : Param&egrave;tre l'introduction &agrave; la room qui sera affich&eacute;e \xE0 tous les utilisateurs la rejoignant",
    ...
    "- !htmlbox <em>HTML code</em>: broadcast a box of HTML code to the room": "- !htmlbox <em>code HTML</em> : Affiche une bo\xEEte cod&eacute;e en HTML sur la room",
    ...
    "- /roomsettings: change a variety of room settings, including modchat, capsfilter, etc": "- /roomsettings : Permet de changer plusieurs param&egrave;tres de la room y compris le modchat, le filtre \xE0 majuscules, etc",
    ...
    "- /tour banlist [pokemon], [talent], [...]: ban moves, abilities, Pok\xE9mon or items from being used in a tournament (it must be created first)": "- /tour banlist [pokemon], [talent], [...] : Bannit des attaques, talents, Pok&eacute;mon ou objets d'un tournoi (cette liste doit &ecirc;tre cr&eacute;&eacute;e au pr&eacute;alable)",
