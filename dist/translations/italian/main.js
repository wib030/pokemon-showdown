...
const translations = {
  ...
  strings: {
    ...
    "* <strong>Global Bot</strong> - Like Moderator, but makes it clear that this user is a bot": "* <strong>Global Bot</strong> - Come i Global Moderator, ma il simbolo specifica che l'utente \xE8 un bot",
    ...
    "* <strong>Bot</strong> - Like Moderator, but makes it clear that this user is a bot": "* <strong>Bot</strong> - Come i Moderator, ma il simbolo specifica che l'utente \xE8 un bot",
    ...
    "<strong>lock</strong> - Locks a user (makes them unable to talk in any rooms or PM non-staff) for 2 days.": "<strong>lock</strong> - Locka un utente (gli impedisce di parlare in qualsiasi room o di mandare messaggi privati a chi non \xE8 staff) per 2 giorni.",
    ...
    "<strong>permalock</strong> - Issued for repeated instances of bad behavior and is rarely the result of a single action. ": "<strong>permalock</strong> - Punizione data per casi ripetuti di comportamenti inadeguati e raramente \xE8 il risultato di una singola azione. ",
    'These can be appealed in the <a href="https://www.smogon.com/forums/threads/discipline-appeal-rules.3583479/">Discipline Appeal</a>': '\xC8 possibile fare ricorso a questa punizione nel forum <a href="https://www.smogon.com/forums/threads/discipline-appeal-rules.3583479/">Discipline Appeal</a>',
    " forum after at least 3 months without incident.": " dopo un minimo di 3 mesi dall'ultimo incidente.",
    "<strong>permaban</strong> - Unappealable global ban typically issued for the most severe cases of offensive/inappropriate behavior.": "<strong>permaban</strong> - Ban globale inappellabile dato per i casi pi\xF9 severi di comportamento offensivo e/o inappropriato.",
    ...
    "- /tour banlist [pokemon], [talent], [...]: ban moves, abilities, Pok\xE9mon or items from being used in a tournament (it must be created first)": "- /tour banlist [pokemon], [talent], [...]: banna mosse, abilit&agrave;, Pok&eacute;mon o strumenti dal torneo (prima &egrave; necessario creare il torneo)",
    ...
    "Your status cannot be updated while you are locked or semilocked.": "Il tuo stato non pu\xF2 essere aggiornato mentre sei lockato o semilockato.",
    "Your status is too long; it must be under ${maxLength} characters.": "Il tuo stato \xE8 troppo lungo; deve avere una lunghezza inferiore a ${maxLength} caratteri.",
    "Your status contains a banned word.": "Il tuo stato contiene una parola proibita.",
    "Your status has been set to: ${target}.": "Il tuo stato \xE8 stato cambiato in: ${target}.",
    ...
    "You are already marked as back.": "Sei gi\xE0 indicato come back (attivo).",
    "You are no longer marked as busy.": "Non sei pi\xF9 indicato come busy (occupato).",
    ...
    "Because moderated chat is set, your account must be at least one week old and you must have won at least one ladder game to speak in this room.": "Poich\xE9 la chat moderata \xE8 attiva, devi essere registrato da almeno una settimana e aver vinto una lotta in ladder.",
    "Because moderated chat is set, your account must be staff in a public room or have a global rank to speak in this room.": "Poich\xE9 la chat moderata \xE8 attiva, il tuo account deve essere staff in una room pubblica o avere un rank globale per parlare in questa room.",
    "Because moderated chat is set, you must be of rank ${groupName} or higher to speak in this room.": "Poich\xE9 la chat moderata \xE8 attiva, devi avere il rank di ${groupName} o superiore per parlare in questa room.",
    "Your message can't be blank.": "Il tuo messaggio non pu\xF2 essere vuoto.",
    "Your message is too long.": "Il tuo messaggio \xE8 troppo lungo:",
    ...
    'The user "${targetUser.name}" is locked and cannot be PMed.': 'Questo utente "${targetUser.name}" \xE8 lockato e non \xE8 possibile mandargli un messaggio privato.',
    ...
    "This ${Config.groups[targetUser.group].name} is too busy to answer private messages right now. Please contact a different staff member.": "Al momento, questo ${Config.groups[targetUser.group].name} \xE8 troppo impegnato per rispondere ai messaggi privati. Per favore, contatta un altro membro dello staff.",
    ...
    "Your message contained banned words in this room.": "Il tuo messaggio conteneva una o pi\xF9 parole non permesse in questa room.",
    "You can't send the same message again so soon.": "Non puoi inviare lo stesso messaggio di nuovo dopo cos\xEC poco tempo",
    "Due to this room being a high traffic room, your message must contain at least two letters.": "Poich\xE9 questa \xE8 una room molto affollata, il tuo messaggio deve contenere almeno due lettere.",
    "You are already blocking private messages! To unblock, use /unblockpms": "Stai gi\xE0 bloccando i messaggi privati! Per sbloccarli, usa /unblockpms",
    ...
    "You are no longer blocking private messages.": "Non stai pi\xF9 bloccando i messaggi privati.",
    "You are now blocking all incoming challenge requests.": "Stai ora bloccando ogni richiesta di sfida in arrivo.",
    "You are already blocking challenges!": "Stai gi\xE0 bloccando le sfide!",
    "You are already available for challenges!": "Sei gi\xE0 disponibile per le sfide!",
    ...
    "A user is autoconfirmed when they have won at least one rated battle and have been registered for one week or longer. In order to prevent spamming and trolling, most chatrooms only allow autoconfirmed users to chat. If you are not autoconfirmed, you can politely PM a staff member (staff have %, @, or # in front of their username) in the room you would like to chat and ask them to disable modchat. However, staff are not obligated to disable modchat.": 'Un utente \xE8 "autoconfirmed" quando ha vinto almeno una lotta a punti ed \xE8 registrato da una o pi\xF9 settimane. In modo da prevenire episodi di spam e trolling, la maggior parte delle chatroom permette unicamente agli utenti autoconfirmed di parlare. Nel caso in cui tu non sia autoconfirmed, chiedi educatamente ad un membro dello staff (lo staff \xE8 contrassegnato dai simboli %, @ o # vicino al loro nome utente) della room nella quale vuoi parlare e chiedi loro di disattivare la modchat. Tuttavia, lo staff non \xE8 in alcun modo obbligato a disattivare la modchat.',
