...
const translations = {
  strings: {
    ...
    "Report harassment in a private message (PM)": "Rapporteer intimidatie in een priv\xE9 bericht (PM)",
    ...
    "Please give us all relevant information on how you are connecting to Pok\xE9mon Showdown (if it is through mobile data, at home, a school or work network, etc), and we will review your case as soon as possible.": "Geef ons alsjeblieft alle relevante informatie over hoe je verbinding maakt met Pok\xE9mon Showdown (als het via mobiele data, thuis, een school- of werknetwerk, etc. is), en we zullen je zaak zo snel mogelijk beoordelen.",
    ...
    "If your issue pertains to battle mechanics or is a question about Pok\xE9mon Showdown, you can ask in the <<help>> chatroom.": "Als je probleem betrekking heeft op gevechtsmechanieken of een vraag is over Pok\xE9mon Showdown, kun je dit vragen in de <<help>> kamer."
  }
};
