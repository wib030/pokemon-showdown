...
const translations = {
  ...
  strings: {
    ...
    "<strong>lock</strong> - Locks a user (makes them unable to talk in any rooms or PM non-staff) for 2 days.": "<strong>lock</strong> - Lockt een gebruiker (maakt het onmogelijk om in rooms te praten en priv\xE9berichten te sturen naar niet-stafleden) voor 2 dagen.",
    ...
    "<strong>permalock</strong> - Issued for repeated instances of bad behavior and is rarely the result of a single action. ": "<strong>permalock</strong> - Uitgegeven voor herhaalde gevallen van slecht gedrag. Deze straf is zelden het resultaat van slechts \xE9\xE9n enkele actie. ",
    ...
    "- /tour banlist [pokemon], [talent], [...]: ban moves, abilities, Pok\xE9mon or items from being used in a tournament (it must be created first)": "- /tour banlist [pokemon], [talent], [...]: Verbiedt aanvallen, abilities, Pok&eacute;mon of items in een toernooi (het toernooi moet wel eerst aangemaakt worden).",
    ...
    "A user is autoconfirmed when they have won at least one rated battle and have been registered for one week or longer. In order to prevent spamming and trolling, most chatrooms only allow autoconfirmed users to chat. If you are not autoconfirmed, you can politely PM a staff member (staff have %, @, or # in front of their username) in the room you would like to chat and ask them to disable modchat. However, staff are not obligated to disable modchat.": "Een gebruiker is autoconfirmed wanneer hij minstens \xE9\xE9n beoordeeld gevecht heeft gewonnen en \xE9\xE9n week of langer is geregistreerd. Om spammen en trollen te voorkomen, laten de meeste chatrooms alleen autoconfirmed gebruikers toe om te chatten. Als je niet autoconfirmed bent, kun je beleefd een PM sturen naar een stafflid (staff hebben %, @, of # voor hun gebruikersnaam) in de room waar je wilt chatten en vragen om modchat uit te schakelen. Echter, staff zijn niet verplicht om modchat uit te schakelen.",
