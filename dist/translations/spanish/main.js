...
const translations = {
  ...
  strings: {
    ...
    "% <strong>Global Driver</strong> - Like Voice, and they can lock users and check for alts": "% <strong>Global Driver</strong> - Como los Voice, y tambi\xE9n pueden dar locks y revisar las alts",
    "@ <strong>Global Moderator</strong> - The above, and they can globally ban users": "@ <strong>Global Moderator</strong> - Lo mismo que arriba y adem\xE1s pueden expulsar globalmente del servidor",
    "* <strong>Global Bot</strong> - Like Moderator, but makes it clear that this user is a bot": "* <strong>Global Bot</strong> - Igual que un moderador, pero el s\xEDmbolo identifica que es un Bot",
    ...
    "^ <strong>Prize Winner</strong> - They don't have any powers beyond a symbol.": "^ <strong>Prize Winner</strong> - No tienen ning\xFAn poder m\xE1s all\xE1 del s\xEDmbolo.",
    "+ <strong>Voice</strong> - They can use ! commands like !groups": "+ <strong>Voice</strong> - Pueden utilizar comandos con ! como !groups",
    "% <strong>Driver</strong> - The above, and they can mute and warn": "% <strong>Driver</strong> - Lo mismo que arriba y adem\xE1s pueden sancionar dando advertencias o silenciando",
    "@ <strong>Moderator</strong> - The above, and they can room ban users": "@ <strong>Moderator</strong> - Lo mismo que arriba y adem\xE1s pueden expulsar a usuarios de la sala",
    "* <strong>Bot</strong> - Like Moderator, but makes it clear that this user is a bot": "* <strong>Bot</strong> - Igual que un moderador, pero el s\xEDmbolo identifica que es un Bot",
    "# <strong>Room Owner</strong> - They are leaders of the room and can almost totally control it": "# <strong>Room Owner</strong> - L\xEDderes de la sala y tienen casi todo el control de lo que sucede en esta",
    ...
    "For details of a specific command, use something like: /help data": "Para detalles de un comando espec\xEDfico, usa algo como: /help data",
    "COMMANDS": "COMANDOS",
    "BATTLE ROOM COMMANDS": "COMANDOS PARA CHATS DE BATALLA",
    "OPTION COMMANDS": "COMANDOS DE OPCI\xD3N",
    ...
    "(replace / with ! to broadcast. Broadcasting requires: + % @ # ~)": "(sustituye / con ! para hacer p\xFAblico un comando. Esto requiere: + % @ # ~)",
    ...
    "<strong>Indefinite global punishments</strong>:": "<strong>Sanciones globales de duraci\xF3n indeterminada</strong>:",
    "<strong>permalock</strong> - Issued for repeated instances of bad behavior and is rarely the result of a single action. ": "<strong>permalock</strong> - Aplicado ante m\xFAltiples instancias de mal comportamiento, rara vez por una sola acci\xF3n. ",
    ...
    " forum after at least 3 months without incident.": " despu\xE9s de m\xEDnimo 3 meses sin incidentes.",
    "<strong>permaban</strong> - Unappealable global ban typically issued for the most severe cases of offensive/inappropriate behavior.": "<strong>permaban</strong> - Expulsi\xF3n global inapelable, generalmente aplicada por ofensas extremadamente graves o inapropiadas.",
    ...
    "- /tour banlist [pokemon], [talent], [...]: ban moves, abilities, Pok\xE9mon or items from being used in a tournament (it must be created first)": "- /tour banlist [pokemon], [talent], [...]: prohibe movimientos, habilidades, Pok&eacute;mon o el uso de objetos en un torneo (debe ser creado primero)",
    ...
    "Your status cannot be updated while you are locked or semilocked.": "Tu estado no puede ser actualizado mientras est\xE1s locked (bloqueado) o semilocked (semibloqueado).",
    ...
    "You are now marked as busy.": "Ahora est\xE1s marcado como busy (ocupado).",
    "You are now marked as away. Send a message or use /back to indicate you are back.": "Ahora est\xE1s marcado como away (ausente). Env\xEDa un mensaje o usa /back para indicar que has vuelto.",
    "You are already marked as back.": "Ya est\xE1s marcado como de vuelta (back).",
    "You are no longer marked as busy.": "Ya no est\xE1s marcado como busy (ocupado).",
    "You must choose a name before you can talk.": "Tienes que escoger un nombre antes de poder hablar.",
    "You are ${lockType} and can't talk in chat. ${lockExpiration}": "Has sido ${lockType} y no podr\xE1s hablar en el chat. ${lockExpiration}",
    "Get help with [TN: your lock]this": "Consigue ayuda con aqu\xED.",
    "You are muted and cannot talk in this room.": "Has sido silenciado y no puedes hablar en esta sala.",
    "Because moderated chat is set, your account must be at least one week old and you must have won at least one ladder game to speak in this room.": "Como el chat moderado est\xE1 activado, tu cuenta debe estar registrada por una semana y tienes que haber ganado un m\xEDnimo de una partida",
    "Because moderated chat is set, your account must be staff in a public room or have a global rank to speak in this room.": "Como el chat moderado est\xE1 activado, tu cuenta debe ser staff en una sala p\xFAblica o debe tener rango global para hablar en esta sala.",
    "Because moderated chat is set, you must be of rank ${groupName} or higher to speak in this room.": "Como el chat moderado est\xE1 activado, tienes que ser del rango ${groupName} o superior para hablar en esta sala.",
    "Your message can't be blank.": "Tu mensaje no puede estar en blanco.",
    "Your message is too long: ": "Tu mensaje es demasiado largo.",
    "Your message contains banned characters.": "Tu mensaje contiene car\xE1cteres proh\xEDbidos.",
    ...
    "Your username contains a phrase banned by this room.": "Tu nombre de usuario contiene una frase proh\xEDbida en esta sala.",
    "Your status message contains a phrase banned by this room.": "Tu status contiene una frase proh\xEDbida en esta sala.",
    ...
    "Your message contained banned words in this room.": "Tu mensaje contiene palabras proh\xEDbidas en esta sala.",
    "You can't send the same message again so soon.": "No puedes mandar el mismo mensaje tan pronto.",
    "Due to this room being a high traffic room, your message must contain at least two letters.": "Debido a que esta sala es de mucho tr\xE1fico de mensajes, tu mensaje tiene que contener al menos dos letras.",
    "You are already blocking private messages! To unblock, use /unblockpms": "\xA1Ya est\xE1s bloqueando mensajes privados! Para desbloquearlos usa /unblockpms",
    "You are now blocking private messages, except from staff and ${rank}.": "Ahora est\xE1s bloqueando mensajes privados, con excepci\xF3n del staff y ${rank}.",
    "You are now blocking private messages, except from staff and ${status} users.": "Ahora est\xE1s bloqueando mensajes privados, con excepci\xF3n del staff y usuarios ${status}.",
    "You are now blocking private messages, except from staff.": "Ahora est\xE1s bloqueando mensajes privados, con excepci\xF3n del staff.",
    "You are not blocking private messages! To block, use /blockpms": "\xA1No est\xE1s bloqueando mensajes privados! Para bloquearlos usa /blockpms",
    "You are no longer blocking private messages.": "Ya no est\xE1s bloqueando mensajes privados.",
    "You are now blocking all incoming challenge requests.": "Ahora est\xE1s bloqueando todas las solicitudes de batalla entrantes",
    "You are already blocking challenges!": "\xA1Ya est\xE1s bloqueando solicitudes de batalla!",
    "You are already available for challenges!": "\xA1Ya est\xE1s disponible para recibir solicitudes de batalla!",
    "You are available for challenges from now on.": "Est\xE1s disponible para recibir solicitudes de batalla de ahora en adelante.",
