...
export declare class Battle {
     ...
     */
    comparePriority(this: void, a: AnyObject, b: AnyObject): number;
    static compareRedirectOrder(this: void, a: AnyObject, b: AnyObject): number;
    static compareLeftToRightOrder(this: void, a: AnyObject, b: AnyObject): number;
     ...
     */
    fieldEvent(eventid: string, targets?: Pokemon[]): void;
    /** The entire event system revolves around this function and runEvent. */
    singleEvent(eventid: string, effect: Effect, state: EffectState | Record<string, never> | null, target: string | Pokemon | Side | Field | Battle | null, source?: string | Pokemon | Effect | false | null, sourceEffect?: Effect | string | null, relayVar?: any, customCallback?: unknown): any;
    /**
    ...
    resolvePriority(h: EventListenerWithoutPriority, callbackName: string): EventListener;
    getCallback(target: Pokemon | Side | Field | Battle, effect: Effect, callbackName: string): Function | undefined;
    ...
    findBattleEventHandlers(callbackName: string, getKey?: 'duration', customHolder?: Pokemon): EventListener[];
    ...
    checkMoveMakesContact(move: ActiveMove, attacker: Pokemon, defender: Pokemon, announcePads?: boolean): boolean;
    ...
    clearRequest(): void;
    getRequests(type: RequestState): ChoiceRequest[];
    tiebreak(): boolean;
    ...
    clearEffectState(state: EffectState): void;
    destroy(): void;
}
export {};
