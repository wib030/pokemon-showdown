 ...
 */
export declare function assignMissingFields(self: AnyObject, data: AnyObject): void;
export declare abstract class BasicEffect implements EffectData {
    /**
...
export interface TypeDataTable {
    [typeid: IDEntry]: TypeData;
}
export interface ModdedTypeDataTable {
    [typeid: IDEntry]: ModdedTypeData;
}
