...
export declare const Teams: {
    ...
    packName(this: void, name: string | undefined | null): string;
     ...
     */
    export(team: PokemonSet[], options?: ExportOptions): string;
    exportSet(set: PokemonSet, { hideStats, removeNicknames }?: ExportOptions): string;
    parseExportedTeamLine(line: string, isFirstLine: boolean, set: PokemonSet, aggressive?: boolean): void;
