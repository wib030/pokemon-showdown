...
class BattleActions {
  ...
  hitStepInvulnerabilityEvent(targets, pokemon, move) {
    ...
    for (const [i, target] of targets.entries()) {
      if (target.volatiles["commanding"]) {
        ...
        hitResults[i] = true;
      } else if (move.id === "thunderwave" && pokemon.hasType("Electric")) {
        hitResults[i] = true;
      } else {
  ...
  hitStepAccuracy(targets, pokemon, move) {
    ...
    for (const [i, target] of targets.entries()) {
      ...
      if (move.alwaysHit || move.id === "toxic" && pokemon.hasType("Poison") || move.id === "thunderwave" && pokemon.hasType("Electric") || move.target === "self" && move.category === "Status" && !target.isSemiInvulnerable()) {
        accuracy = true;
      } else {
