...
export interface EventMethods {
    ...
    onTryHeal?: (((this: Battle, relayVar: number, target: Pokemon, source: Pokemon, effect: Effect) => number | boolean | null | void));
...
export interface ConditionDataTable {
    [id: IDEntry]: ConditionData;
}
export interface ModdedConditionDataTable {
    [id: IDEntry]: ModdedConditionData;
}
export declare class Condition extends BasicEffect implements Readonly<BasicEffect & SideConditionData & FieldConditionData & PokemonConditionData> {
    readonly effectType: 'Condition' | 'Weather' | 'Status' | 'Terrain';
