...
interface ModdedBattleActions {
    ...
    switchIn?: (this: BattleActions, pokemon: Pokemon, pos: number, sourceEffect: Effect | null, isDrag?: boolean) => boolean | "pursuitfaint";
    ...
    useMove?: (this: BattleActions, move: Move, pokemon: Pokemon, options?: {
        target?: Pokemon | null;
        sourceEffect?: Effect | null;
        zMove?: string;
        maxMove?: string;
    }) => boolean;
    useMoveInner?: (this: BattleActions, move: Move, pokemon: Pokemon, options?: {
        target?: Pokemon | null;
        sourceEffect?: Effect | null;
        zMove?: string;
        maxMove?: string;
...
interface ModdedBattlePokemon {
    ...
    setAbility?: (this: Pokemon, ability: string | Ability, source?: Pokemon | null, sourceEffect?: Effect | null, isFromFormeChange?: boolean, isTransform?: boolean) => ID | false | null;
...
interface ModdedBattleScriptsData extends Partial<BattleScriptsData> {
    ...
    boost?: (this: Battle, boost: SparseBoostsTable, target: Pokemon, source?: Pokemon | null, effect?: Effect | null, isSecondary?: boolean, isSelf?: boolean) => boolean | null | 0;
...
declare namespace RandomTeamsTypes {
    ...
    interface RandomDraftFactorySet {
        name: string;
        species: string;
        gender: string;
        moves: string[];
