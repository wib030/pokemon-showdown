...
const Abilities = {
  ...
  embodyaspectcornerstone: {
    onStart(pokemon) {
      if (pokemon.baseSpecies.name === "Ogerpon-Cornerstone-Tera" && pokemon.terastallized && this.effectState.embodied !== pokemon.previouslySwitchedIn) {
  ...
  embodyaspecthearthflame: {
    onStart(pokemon) {
      if (pokemon.baseSpecies.name === "Ogerpon-Hearthflame-Tera" && pokemon.terastallized && this.effectState.embodied !== pokemon.previouslySwitchedIn) {
        this.effectState.embodied = pokemon.previouslySwitchedIn;
  ...
  embodyaspectteal: {
    onStart(pokemon) {
      if (pokemon.baseSpecies.name === "Ogerpon-Teal-Tera" && pokemon.terastallized && this.effectState.embodied !== pokemon.previouslySwitchedIn) {
        this.effectState.embodied = pokemon.previouslySwitchedIn;
  ...
  embodyaspectwellspring: {
    onStart(pokemon) {
      if (pokemon.baseSpecies.name === "Ogerpon-Wellspring-Tera" && pokemon.terastallized && this.effectState.embodied !== pokemon.previouslySwitchedIn) {
        this.effectState.embodied = pokemon.previouslySwitchedIn;
  ...
  relentless: {
    // Implemented in mustrecharge condition at mods/gen4/conditions.ts
    flags: { rollable: 1 },
    name: "Relentless",
    rating: 3,
    num: -7
