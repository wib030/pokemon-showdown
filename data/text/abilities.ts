export const AbilitiesText: {[k: string]: AbilityText} = {
	...
	orbit: {
		name: "Orbit",
		shortDesc: "On switch-in, this Pokemon intensifies Gravity.",

		activate: "  [POKEMON] intensified gravity!",
	},
	magical: {
		name: "Magical",
		shortDesc: "On switch-in, this Pokemon activates Magic Room.",

		activate: "  [POKEMON] activated Magic Room!",
	},
};
